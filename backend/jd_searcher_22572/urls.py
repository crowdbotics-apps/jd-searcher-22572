"""jd_searcher_22572 URL Configuration
...
admin.site.site_header = "JD Searcher"
admin.site.site_title = "JD Searcher Admin Portal"
admin.site.index_title = "JD Searcher Admin"

# swagger
api_info = openapi.Info(
    title="JD Searcher API",
    default_version="v1",
    description="API documentation for JD Searcher App",
)
